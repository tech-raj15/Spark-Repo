...
public class TestSmartNews1 {

    public static String removeAdjoiningCharacter(String str) {
	// remove A adjoining AB
	return str.replace("AB", "").replace("BA", "").replace("CD", "").replace("DC", "");

    }
    public static void main(String[] args) {
	String str = "ABCD";
	System.out.println(removeAdjoiningCharacter("ABCD"));
	System.out.println(removeAdjoiningCharacter("CBACD"));
	System.out.println(removeAdjoiningCharacter("CABABD"));
    }
